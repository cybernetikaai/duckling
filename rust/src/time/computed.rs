...
pub fn computed_holiday_shift_rules() -> Vec<Rule> {
    vec![
        computed_holiday_shift(
            "Ascension Day",
            r"ascension\s+(thurs)?day",
            EASTER_SUNDAY,
            39,
        ),
        computed_holiday_shift(
            "Ash Wednesday",
            r"ash\s+wednesday|carnival",
            EASTER_SUNDAY,
            -46,
        ),
        computed_holiday_shift(
            "Corpus Christi",
            r"(the feast of )?corpus\s+christi",
            EASTER_SUNDAY,
            60,
        ),
        ...
        computed_holiday_shift(
            "Palm Sunday",
            r"(branch|palm|yew)\s+sunday",
            EASTER_SUNDAY,
            -7,
        ),
        computed_holiday_shift(
            "Pentecost",
            r"pentecost|white sunday|whitsunday",
            EASTER_SUNDAY,
            49,
        ),
        computed_holiday_shift(
        ...
        computed_holiday_shift(
            ...
            r"orthodox\s+easter\s+mon(day)?",
            ORTHODOX_EASTER,
            1,
        ),
        computed_holiday_shift(
            "Orthodox Holy Saturday",
            r"orthodox\s+holy\s+sat(urday)?",
            ORTHODOX_EASTER,
            -1,
        ),
        computed_holiday_shift(
        ...
        computed_holiday_shift(
            ...
            r"orthodox\s+(branch|palm|yew)\s+sunday",
            ORTHODOX_EASTER,
            -7,
        ),
        computed_holiday_shift(
        ...
        computed_holiday_shift(
            "Govardhan Puja",
            r"govardhan\s+puja|annak(u|oo)t",
            DHANTERAS,
            3,
        ),
        computed_holiday_shift(
        ...
        computed_holiday_shift(
            "Holi",
            r"(rangwali )?holi|dhuleti|dhulandi|phagwah",
            VASANT_PANCHAMI,
            39,
        ),
        computed_holiday_shift(
...
fn paired_interval_days(start_ymd: &[(i16, i8, i8)], end_ymd: &[(i16, i8, i8)]) -> Vec<TimeObject> {
...
pub fn computed_holiday_rules() -> Vec<Rule> {
    vec![
        ...
        computed_holiday(
            "Vaisakhi",
            r"mesadi|[bv]aisakhi|vaisakhadi|vasakhi|vaishakhi",
            VAISAKHI,
        ),
        computed_holiday(
            "Mawlid",
        ...
        computed_holiday(
            "Karva Chauth",
            r"karva\s+chauth|karaka\s+chaturthi",
            KARVA_CHAUTH,
        ),
        computed_holiday(
            "Krishna Janmashtami",
        ...
        computed_holiday(
            "Parsi New Year",
            r"parsi new year|jamshedi navroz",
            PARSI_NEW_YEAR,
        ),
